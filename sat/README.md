...
Commands reference :  
[SAT module](http://sdr4.space/doc/sdr4space_lite_en/#sat-module)  
[Satellit object](http://groundcom.sdr4.space/doc/jsatellite/)
...
` /usr/src/SDR4space/sdrvm -f ./sat/0_big_TLE.js `
...
`/usr/src/SDR4space/sdrvm -f ./sat/1_simple_ISS.js `  
...
`/usr/src/SDR4space/sdrvm -f ./sat/2_ISS_details.js`
